Попробуй понять, что выполняется в этой инструкции, поняв это напиши собственную инструкцию на английском языке, используя лучшие практики написания инструкций: 
